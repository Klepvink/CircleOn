...
class EngineInstance:
    def __init__(self, chessboardInstance):
        ...
        self.originalBitboard = "1100001111000011110000111100001111000011110000111100001111000011"
    ...
    async def _pass_and_return(self, move):
        ...
        if self.originalBitboard != self.chessboardInstance.board_to_occupation_string():
            ...
            await self.uartInstance.send_command(f"25#{"".join(diff_squares)}*".encode())
            diff_squares = []